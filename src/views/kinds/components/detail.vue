    ...
    <el-card shadow="always" :body-style="{ padding: '20px' }">
      <el-form :model="model" :rules="rules" ref="form" label-position="top">
        <el-form-item label="菜品种类" prop="name">
          <el-input v-model="model.name" placeholder="请输入菜品种类名称" clearable></el-input>
        </el-form-item>
...
import { useItem } from '../models/kindModel'
  ...
  setup(props) {
    ...
    const data = reactive({
      rules: {
        ...
        name: [{ required: true, message: '请输入菜品种类名称', trigger: 'blur' }]
      },
